...
jr_define( '_JOMRES_COM_MR_EB_ROOM_BOOKINGSPAYMENT', 'Payment method ' );//nuevo forma de pago
...
jr_define( '_JOMRES_CUSTOMTEXT_GATEWAYNAMEcheque', 'Bank Transfer' );
jr_define('_JOMRES_CUSTOMTEXT_SENDDEPOSITTOcheque','Temporal booking. Please to complete the booking send your deposit of ');
jr_define('_JOMRES_CUSTOMTEXT_BELOWADDRESScheque',' to acount number IBAN/BIC: ES05 2100 0438 9601 0082 9924  SWIFT: CAIXESBBXXX');
jr_define('_JOMRES_CUSTOMTEXT_CONTACTUS1cheque','If you have any problems, please do not hesitate to contact us.');
jr_define('_JOMRES_CUSTOMTEXT_CONTACTUS2cheque',' email us at ');
jr_define('_JOMRES_CUSTOMTEXT_SUBMITcheque','Confirm Temporal Booking');
// 4.7.8
